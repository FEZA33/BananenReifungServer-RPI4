 ...
 */
package ProzessControl;

import java.util.StringTokenizer;
import java.util.logging.Level;
import java.util.logging.Logger;
import ServerSeite.Simulator;
...
//}
    ...
    private void prozessArbeit() {
        ...
        int tempSoll = Integer.valueOf(this.getS1SETTEMP()) / 10;
        int tempIst = simulator.getjSliderTemp().getValue();
        int tol = Integer.valueOf(this.getS1SETTEMPTOL());
...
//        }
    ...
    public void prozessDaten(String text) {
